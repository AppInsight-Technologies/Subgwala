                              ...
                              child: Row(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text("Express",style: TextStyle(fontSize: 8,color: ColorCodes.primaryColor,fontWeight: FontWeight.w800),),
                                  ),
                        ...
                        VxBuilder(
                          ...
                          builder: (context, GroceStore box, _) {
                            ...
                            if(_checkmembership) { //Membered user
                              if(widget._itemdata.membershipDisplay!){ //Eligible to display membership price
                                _price = widget._itemdata.membershipPrice!;
                                _mrp = widget._itemdata.mrp!;
                              } else if(widget._itemdata.discointDisplay!){ //Eligible to display discounted price
                                _price = widget._itemdata.price!;
                                _mrp = widget._itemdata.mrp!;
                              } else { //Otherwise display mrp
                                _price = widget._itemdata.mrp!;
                              }
                            } else { //Non membered user
                              if(widget._itemdata.discointDisplay!){ //Eligible to display discounted price
                                _price = widget._itemdata.price!;
                                _mrp = widget._itemdata.mrp!;
                              } else { //Otherwise display mrp
                                _price = widget._itemdata.mrp!;
                            ...
                            return  Row(
                              children: <Widget>[
                                ...
                                Spacer(),
                                _checkmembership ? widget._itemdata.membershipDisplay! ?
                                Container(
                                  height: 20,
                                  decoration: BoxDecoration(
                                    border: Border(
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                            Features.iscurrencyformatalign? "Savings" + " " +
                                                (double.parse(widget._itemdata.mrp!) - double.parse(widget._itemdata.membershipPrice!)).toStringAsFixed(IConstants.numberFormat == "1"?0:IConstants.decimaldigit) + IConstants.currencyFormat: "Savings" + " " +
                                                IConstants.currencyFormat +
                                                (double.parse(widget._itemdata.mrp!) - double.parse(widget._itemdata.membershipPrice!)).toStringAsFixed(IConstants.numberFormat == "1"?0:IConstants.decimaldigit),
              ...
              (Features.netWeight && widget._itemdata.vegType == "fish")
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("G Weight:" + " " + widget._itemdata.priceVariation![itemindex].weight!,
                            style: new TextStyle(fontSize: ResponsiveLayout.isSmallScreen(context) ? 10 : ResponsiveLayout.isMediumScreen(context) ? 11 : 11, fontWeight: FontWeight.bold)
                        ),
                      ],
                    ),
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                        Text("N Weight:" + " " + widget._itemdata.priceVariation![itemindex].netWeight!,
                            style: new TextStyle(fontSize: ResponsiveLayout.isSmallScreen(context) ? 10 : ResponsiveLayout.isMediumScreen(context) ? 11 : 11, fontWeight: FontWeight.bold)
                        ),
                      ],
                    ),
                      ...
                      children: [
                        VxBuilder(
                          ...
                          builder: (context, GroceStore box, _) {
                            ...
                            if(_checkmembership) { //Membered user
                              if(widget._itemdata.priceVariation![itemindex].membershipDisplay!){ //Eligible to display membership price
                                _price = widget._itemdata.priceVariation![itemindex].membershipPrice!;
                                _mrp = widget._itemdata.priceVariation![itemindex].mrp!;
                              } else if(widget._itemdata.priceVariation![itemindex].discointDisplay!){ //Eligible to display discounted price
                                _price = widget._itemdata.priceVariation![itemindex].price!;
                                _mrp = widget._itemdata.priceVariation![itemindex].mrp!;
                              } else { //Otherwise display mrp
                                _price = widget._itemdata.priceVariation![itemindex].mrp!;
                              }
                            } else { //Non membered user
                              if(widget._itemdata.priceVariation![itemindex].discointDisplay!){ //Eligible to display discounted price
                                _price = widget._itemdata.priceVariation![itemindex].price!;
                                _mrp = widget._itemdata.priceVariation![itemindex].mrp!;
                              } else { //Otherwise display mrp
                                _price = widget._itemdata.priceVariation![itemindex].mrp!;
                            ...
                            return  Row(
                              children: <Widget>[
                                ...
                                Spacer(),
                                _checkmembership ? widget._itemdata.priceVariation![Features.btobModule?_groupValue:itemindex].membershipDisplay! ?
                                Container(
                                  height: 20,
                                  decoration: BoxDecoration(
                                    border: Border(
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                            Features.iscurrencyformatalign?
                                            (double.parse(widget._itemdata.priceVariation![Features.btobModule?_groupValue:itemindex].mrp!) - double.parse(widget._itemdata.priceVariation![Features.btobModule?_groupValue:itemindex].membershipPrice!)).toStringAsFixed(IConstants.numberFormat == "1"?0:IConstants.decimaldigit) + IConstants.currencyFormat:
                                            IConstants.currencyFormat +
                                                (double.parse(widget._itemdata.priceVariation![Features.btobModule?_groupValue:itemindex].mrp!) - double.parse(widget._itemdata.priceVariation![Features.btobModule?_groupValue:itemindex].membershipPrice!)).toStringAsFixed(IConstants.numberFormat == "1"?0:IConstants.decimaldigit),
                                            style: TextStyle(fontSize: 9, color: ColorCodes.darkgreen,fontWeight: FontWeight.bold)),
                                      ),
