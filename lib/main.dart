...
Future<void> main() async {
  ...
  if(!PrefUtils.prefs!.containsKey("branch"))
    PrefUtils.prefs!.setString("branch", "54");
            ...
            builder: (BuildContext context, store, VxStatus? status) {
              return  MaterialApp.router(
                ...
                theme: ThemeData(
                  ...
                  primarySwatch: MaterialColor(0xffE21C24, {
                    50: Color(0xffE21C24),
                    100: Color(0xffE21C24),
                    200: Color(0xffE21C24),
                    300: Color(0xffE21C24),
                    400: Color(0xffE21C24),
                    500: Color(0xffE21C24),
                    600: Color(0xffE21C24),
                    700: Color(0xffE21C24),
                    800: Color(0xffE21C24),
                    900: Color(0xffE21C24),
                  }),
                  accentColor: MaterialColor(0xffE21C24, {
                    50: Color(0xffE21C24),
                    100: Color(0xffE21C24),
                    200: Color(0xffE21C24),
                    300: Color(0xffE21C24),
