...
class IConstants {
  static String BaseDomain =
      /*"https://hitalife.grocbay.com";*/"https://sandbox.grocbay.com";//"https://saas.grocbay.com";
  static String API_PATH = "$BaseDomain/api/app-manager/get-functionality/";
  static String API_IMAGE = "$BaseDomain/uploads/";
  static String AppDomain = "https://sandbox.grocbay.com";
  ...
  static String APP_NAME = "Subgywala";
  static String API_PAYTM = "https://cashfree.grocbay.com/";

  static String androidId = "" /* = com.subgwala.store"*/;
  ...
  static String refIdForMultiVendor = "1117";
