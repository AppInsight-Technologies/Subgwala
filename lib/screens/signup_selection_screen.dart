...
class SignupSelectionScreenState extends State<SignupSelectionScreen> with Navigations{
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      ...
      print("apple "+PrefUtils.prefs!.getString('applesignin').toString());

      if (PrefUtils.prefs!.getString('applesignin') == "yes") {
        print("asdfghj apple "+PrefUtils.prefs!.getString('apple').toString());
        ...
        body: SafeArea(
          ...
          SingleChildScrollView(
            child: Column(children: <Widget>[
              ...
              Container(
                width: MediaQuery.of(context).size.width / 1.2,
                height: MediaQuery.of(context).size.height / 25,//20.0,
