                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                      (snapshot.where((element) => element.mode! == "1" ).first.membershipPrice == (snapshot.where((element) => element.mode! == "1" ).first.varMrp) || double.parse((snapshot.where((element) => element.mode! == "1" ).first.membershipPrice!)) <= 0)?
                                        new RichText(
                                          text: new TextSpan(
                                            style: new TextStyle(
                                            ...
                                            children: <TextSpan>[
                                              ...
                                              IConstants.numberFormat == "1"?IConstants.currencyFormat + ' ' +(snapshot.where((element) => element.mode! == "1" ).first.varMrp.toString()):IConstants.currencyFormat + ' ' +(snapshot.where((element) => element.mode! == "1" ).first.varMrp.toString()), style: TextStyle(color:ColorCodes.primaryColor,
                                                fontWeight: FontWeight.w500,
                                                fontSize:12,)),
                                            // new TextSpan(text: Features.iscurrencyformatalign?
                                            // IConstants.numberFormat == "1"?' ' + (snapshot.where((element) => element.mode! == "1" ).first.varMrp.toString()) + ' ' + IConstants.currencyFormat:' ' + (snapshot.where((element) => element.mode! == "1" ).first.varMrp.toString()) + ' ' +  IConstants.currencyFormat:
                                        ...
                                        //   fontSize:13,)),
                                          new TextSpan(text: "(" + (snapshot.where((element) => element.mode! == "1" ).first.varName!) +") ", style: TextStyle(color:ColorCodes.primaryColor,
                                              ...
                                              fontSize:12,)),
                                        new TextSpan(text: Features.iscurrencyformatalign?
                                              IConstants.numberFormat == "1"?' ' + (snapshot.where((element) => element.mode! == "1" ).first.membershipPrice.toString()) + ' ' + IConstants.currencyFormat:' ' + (snapshot.where((element) => element.mode! == "1" ).first.membershipPrice.toString()) + ' ' +  IConstants.currencyFormat:
                                              IConstants.numberFormat == "1"?IConstants.currencyFormat + ' ' +(snapshot.where((element) => element.mode! == "1" ).first.membershipPrice.toString()):IConstants.currencyFormat + ' ' +(snapshot.where((element) => element.mode! == "1" ).first.membershipPrice.toString()), style: TextStyle(color:ColorCodes.primaryColor,
                                              fontWeight: FontWeight.w500,
                                              fontSize:12,)),
                                        new TextSpan(text: Features.iscurrencyformatalign?
                                              IConstants.numberFormat == "1"?' ' + (snapshot.where((element) => element.mode! == "1" ).first.varMrp.toString()) + ' ' + IConstants.currencyFormat:' ' + (snapshot.where((element) => element.mode! == "1" ).first.varMrp.toString()) + ' ' +  IConstants.currencyFormat:
