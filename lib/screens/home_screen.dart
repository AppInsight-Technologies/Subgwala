          ...
          children: <Widget>[
            ...
            SizedBox(
                height: ResponsiveLayout.isSmallScreen(context) ? Features.btobModule?420:(Features
                    ...
                    ? 230
                    : 230 : Features.btobModule?410:(Features.isSubscription) ? 250 : 230,
                child: new ListView.builder(
                  shrinkWrap: true,
                  scrollDirection: Axis.horizontal,
              ...
              builder: (context, GroceStore value, widget) {
                ...
                Column(
                  children: [
                    ...
                    if (!PrefUtils.prefs!.containsKey("apikey") && !Vx.isWeb)(Features.isMembership && !Features.ismultivendor) ? Container(
                      height: 35,
                      decoration: BoxDecoration(
