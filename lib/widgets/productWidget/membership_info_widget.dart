...
//                        mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        ...
                        Image.asset(
                          ...
                          height: 11,),
                        SizedBox(width: 3),
                        Text( "Savings ",style: TextStyle(fontSize: ResponsiveLayout.isSmallScreen(context) ? 12 : ResponsiveLayout.isMediumScreen(context) ? 13 : 14,color: ColorCodes.darkgreen,fontWeight: FontWeight.bold)),
                       // Text( /*"Membership Savings "*/S.of(context).membership_saving,style: TextStyle(fontSize: ResponsiveLayout.isSmallScreen(context) ? 10 : ResponsiveLayout.isMediumScreen(context) ? 11 : 12,color: ColorCodes.greenColor,fontWeight: FontWeight.bold)),
                        Padding(
                          ...
                          child: Text(
                              ...
                              (double.parse(itemdata.mrp!) - double.parse(itemdata.membershipPrice!)).toStringAsFixed(IConstants.numberFormat == "1"?0:IConstants.decimaldigit) + IConstants.currencyFormat:
                              IConstants.currencyFormat +
                                  (double.parse(itemdata.mrp!) - double.parse(itemdata.membershipPrice!)).toStringAsFixed(IConstants.numberFormat == "1"?0:IConstants.decimaldigit) /*+ " " +S.of(context).membership_price*/,
...
//                        mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text(
                            Features.iscurrencyformatalign?
                            (double.parse(itemdata.priceVariation![itemindexs].mrp!) - double.parse(itemdata.priceVariation![itemindexs].membershipPrice!)).toStringAsFixed(IConstants.numberFormat == "1"?0:IConstants.decimaldigit) + IConstants.currencyFormat:
                            IConstants.currencyFormat +
                                (double.parse(itemdata.priceVariation![itemindexs].mrp!) - double.parse(itemdata.priceVariation![itemindexs].membershipPrice!)).toStringAsFixed(IConstants.numberFormat == "1"?0:IConstants.decimaldigit) /*+ " " +S.of(context).membership_price*/,
                            style: TextStyle( fontSize: ResponsiveLayout.isSmallScreen(context) ? 12 : ResponsiveLayout.isMediumScreen(context) ? 13 : 14,color: ColorCodes.greenColor,fontWeight: FontWeight.bold)),
                      ),
